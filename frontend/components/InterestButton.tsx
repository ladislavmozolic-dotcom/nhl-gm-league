...
import { clauseDiscount, CONTENTION_LABELS } from "@/lib/free-agency";
              ...
              <>
                ...
                <div className="bg-slate-800/50 border border-slate-700 rounded-lg p-3 mb-3 text-sm">
                  <p className="text-slate-300">
                    ...
                    <span className={contentionStyle[i.contention] ?? "text-slate-300"}>{CONTENTION_LABELS[i.contention] ?? i.contention}</span>
                  </p>
