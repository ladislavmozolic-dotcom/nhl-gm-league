...
export default async function Standings() {
  ...
  return (
    <div className="card p-4">
      <h2 className="text-sm font-bold text-white mb-4">🏆 Standings</h2>

      {noDataAtAll && (
        <p className="text-xs text-amber-400 mb-4">
          Žiadne NHL tímy nenájdené. Skontroluj, či máš v tabuľke Team
          stĺpec <code className="bg-slate-800 px-1 rounded">league</code> s hodnotou <code className="bg-slate-800 px-1 rounded">"NHL"</code>.
        </p>
      )}
  ...
  <Image src="/images/logos/eastern-conference.svg" alt="East" width={32} height={32} />
  <h3 className="text-xs font-bold text-blue-400 uppercase">Eastern Conference</h3>
</div>
      ...
      {westTeams.length > 0 && (
        <div>
            <div className="flex items-center gap-2 mb-3">
  <Image src="/images/logos/western-conference.svg" alt="East" width={32} height={32} />
  <h3 className="text-xs font-bold text-blue-400 uppercase">Eastern Conference</h3>
</div>
