        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 p-4" onClick={() => setOpen(false)}>
          <div className="bg-slate-900 border border-slate-700 rounded-xl w-full max-w-lg max-h-[88vh] overflow-y-auto p-5" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="space-y-3">
              ...
              <div>
                <label className="text-xs text-slate-400 block mb-1">Contract type<InfoTip text="One-way pays the same in NHL or AHL. Two-way pays less on the farm — an established player past 25 (30+ NHL games last season) won't accept one, whatever his rating; young players sign two-ways freely. One year only." /></label>
