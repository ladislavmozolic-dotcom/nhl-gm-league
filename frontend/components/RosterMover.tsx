...
export default function RosterMover({ teamName, teamSlug, affiliateName, hasAffiliate, players, onSave, onRelease, onWaiver }: Props) {
  ...
  // (unless it's AHL-only, or he's still riding his Rule 30/10 recall pass) — that
  // needs to clear waivers first (the Farm/Waivers button), not a direct move. But
  // once he's already ON the farm, toggling him between Farm and Farm Scratched
  // isn't "being sent down" at all — he's already there — so that restriction must
  // not block a farm-internal dress/scratch move.
