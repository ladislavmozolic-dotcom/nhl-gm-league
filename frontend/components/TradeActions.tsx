...
import { respondToTrade, cancelTrade } from "@/app/trades/build/actions";

export default function TradeActions({ tradeId, role }: { tradeId: number; role: "receiver" | "proposer" }) {
