...
function RecordCard({ record, cupName }: { record: RecordSection; cupName: string }) {
  return (
    <div className="rounded-xl border border-slate-800 bg-slate-900/60 overflow-hidden flex flex-col shadow-sm">
      <div className="flex items-center justify-between gap-2 px-3.5 py-2.5 border-b border-slate-800/80 bg-slate-800/30">
        <div className="flex items-center gap-2 min-w-0">
          <span className="text-base leading-none shrink-0" aria-hidden>{record.icon}</span>
