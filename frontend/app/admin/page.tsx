...
const GROUPS: Group[] = [
  {
    ...
    items: [
      ...
      { href: "/admin/special-games", title: "🏟️ Special games", descKey: "admin.specialGames.d" },
      { href: "/admin/discipline", title: "⚖️ Player Safety", descKey: "admin.discipline.d" },
      { href: "/admin/retired-numbers", title: "🎽 Retired numbers", descKey: "admin.retiredNumbers.d" },
