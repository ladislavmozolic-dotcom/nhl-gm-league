  ...
  },
  {
    ...
    groups: [
      ...
      { h: "Tactical Fit — jak to všechno hraje dohromady", points: [
        "Stránka Line Builder hodnotí každou uloženou lajnu/pár jedním číslem „Tactical Fit” (0–100), které skládá TŘI oddělené věci do jedné: Shodu rolí (odstupňované skóre výše), správnost postu a hokejky (stojí každý útočník tam, kam pokrývá jeho post; má obranný pár správnou hokejku — levák vlevo, pravák vpravo), a Shodu systému — STEJNOU míru soupiska-vs-taktika ze Systémové taktiky týmu výše, spočítanou jen ze zprůměrovaných hráčů této jedné lajny proti voličům systému, které máte pro tým nastavené.",
        "Právě tahle třetí složka způsobuje, že Tactical Fit reaguje na Taktiku: lajna poskládaná z hráčů, kteří jednotlivě sedí na váš zvolený systém (rychlí dokončovatelé na Rush týmu, silní přihrávači na cyklovacím týmu), vyjde lépe než stejně rolově vyvážená lajna, která na systém nesedí — a tým hrající výchozí Vyvážený systém touto složkou vůbec neovlivní (Shoda systému je neutrální, ×1,0), takže Tactical Fit se zredukuje jen na Shodu rolí × post/hokejku, dokud se stránky Taktika vůbec nedotknete.",
        "Tactical Fit je plánovací/zobrazovací číslo, ne to, co si sama simulace účtuje každý zápas: promítá se jen do PROJEKTOVANÉ startovní chemie, na které čerstvě sestavený nebo právě přeskládaný svazek začíná (dobře poskládaná, dobře sedící lajna má projektovanou teplejší startovní chemii, než má za sebou jediný společný zápas) — viz „proj” výše. Skutečný postih ve hře za jednotku s duplicitními rolemi jde čistě ze Shody rolí, kterou aplikuje přímo simulace; skutečný efekt Shody systému je taky samostatný — uplatňuje se na úrovni celé SOUPISKY (ne po lajnách), kde škáluje reálné přínosy a náklady vašeho týmového systému během odsimulovaných zápasů, jak je popsáno výše.",
      ] },
    ],
  },
];
