  ...
  },
  {
    ...
    groups: [
      { points: [
        ...
        "Pravidlo hodného brankáře: každý klub musí mít před začátkem sezony na NHL soupisce alespoň jednoho brankáře s hodnocením 72 OV nebo vyšším. Klub, který pod tuto hranici klesne (trejd, sestup na farmu), dostane varování ve své sekci Brankáři, při stavbě trejdu a na komisařském Dashboardu v předletové kontrole — stačí podepsat, vytrejdovat nebo povolat kvalifikovaného brankáře.",
      ] },
    ],
  },
  {
