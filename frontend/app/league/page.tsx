...
export default async function LeagueDirectoryPage() {
  const teams = await prisma.team.findMany({
    ...
    select: { id: true, name: true, code: true, logoUrl: true, slug: true, conference: true, division: true, gm: true, gmNickname: true, gmFirstName: true, gmLastName: true, gmEmail: true, lastLoginAt: true, passwordHash: true, rookieGm: true },
    orderBy: [{ name: "asc" }],
  });
