...
export const DICT: Dict = {
  ...
  "cond.conHintPick": { en: "protect this pick against the draft lottery (TOP10/TOP15)", cs: "chrániť tento pick pred draft lotériou (TOP10/TOP15)" },
  "cond.edit": { en: "edit", cs: "upraviť" },
  "cond.modalTitle": { en: "Conditional pick", cs: "Podmienený pick" },
  "cond.modalTitleLottery": { en: "Protect this pick", cs: "Chráň tento pick" },
  ...
  "cond.descLottery": { en: "Pick B is the pick being protected — it conveys as-is unless its original team's own finish lands it inside the protected range in the Draft Lottery, in which case Pick A conveys instead.", cs: "Pick B je chránený pick — ide tak, ako je, pokiaľ sa jeho pôvodný tím v Draft lotérii neumiestni v chránenom pásme; v tom prípade ide namiesto neho Pick A." },
  ...
  "cond.lotteryProtects": { en: "original team's draft slot lands in the top", cs: "pôvodný tím skončí v žrebe do" },
  ...
  "cond.errRound1Only": { en: "Only a 1st round pick can be lottery-protected.", cs: "Chrániť pred lotériou možno len 1. kolo." },
  "cond.describe": {
