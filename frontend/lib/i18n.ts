...
export const DICT: Dict = {
  ...
  "cond.conHint": { en: "make a draft pick conditional on his real NHL production", cs: "podmieniť draft pick jeho reálnou produkciou v NHL" },
  "cond.edit": { en: "edit", cs: "upraviť" },
  "cond.modalTitle": { en: "Conditional pick", cs: "Podmienený pick" },
  "cond.desc": { en: "Judged on his REAL NHL production (not this league's sims). Pick A conveys as-is unless he clears the bar below, in which case Pick B conveys instead.", cs: "Posudzuje sa podľa jeho SKUTOČNEJ produkcie v NHL (nie zo simulácií tejto ligy). Pick A ide tak, ako je, pokiaľ nesplní podmienku nižšie — v tom prípade ide namiesto neho Pick B." },
  "cond.season": { en: "Real NHL season (start year)", cs: "Reálna NHL sezóna (počiatočný rok)" },
  "cond.metricLabel": { en: "Metric", cs: "Metrika" },
  ...
  "cond.pickA": { en: "Pick A — conveys as-is if NOT met", cs: "Pick A — ide tak, ako je, ak podmienka NIE JE splnená" },
  "cond.pickB": { en: "Pick B — conveys INSTEAD if MET", cs: "Pick B — ide NAMIESTO neho, ak podmienka JE splnená" },
  ...
  "cond.describe": {
    en: "Conditional pick: if {player} does NOT clear {clauses} in {season} (real NHL stats), the {pickA} conveys as-is; if he DOES, the {pickB} conveys instead.",
    cs: "Podmienený pick: ak {player} NEsplní {clauses} v sezóne {season} (reálne NHL štatistiky), ide {pickA} tak, ako je; ak splní, ide namiesto neho {pickB}.",
  },
