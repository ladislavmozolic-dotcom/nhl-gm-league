...
export const DICT: Dict = {
  ...
  "admin.specialGames.d": { en: "Outdoor games and the Global Series on the real NHL calendar — venue, crowd, event income.", cs: "Zápasy pod holým nebom a Global Series podľa reálneho kalendára NHL — štadión, návšteva, príjem." },
  "admin.discipline.d": { en: "Suspensions and fines: automatic reviews, manual rulings and GM appeals.", cs: "Dišťanty a pokuty: automatické posúdenia, ručné rozhodnutia a odvolania GM." },
  "admin.retiredNumbers.d": { en: "Retired jersey numbers per club — real franchise history and GM ceremonies.", cs: "Vyradené čísla klubov — reálna história a ceremónie GM." },
