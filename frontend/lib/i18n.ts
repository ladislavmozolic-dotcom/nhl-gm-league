...
export const DICT: Dict = {
  ...
  "cond.desc": { en: "Pick B conveys as-is by default. If he clears the bar below, Pick A (the better pick) conveys instead.", cs: "Štandardne ide Pick B tak, ako je. Ak splní podmienku nižšie, ide namiesto neho Pick A (lepší pick)." },
  ...
  "cond.describe": {
    en: "Conditional pick: if {player} clears {clauses} in {season} (real NHL stats), the {pickA} conveys instead of the {pickB}; if he does NOT, the {pickB} stays as-is.",
    cs: "Podmienený pick: ak {player} splní {clauses} v sezóne {season} (reálne NHL štatistiky), ide {pickA} namiesto {pickB}; ak nesplní, ostáva {pickB} tak, ako je.",
  },
