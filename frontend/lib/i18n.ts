...
export const DICT: Dict = {
  ...
  "cond.source.LOTTERY": { en: "Draft Lottery protection", cs: "Ochrana pred Draft lotériou" },
  "cond.lotteryPickBHint": { en: "Pick B must be a 1st round pick — that's the one being protected.", cs: "Pick B musí byť 1. kolo — to je pick, ktorý sa chráni." },
